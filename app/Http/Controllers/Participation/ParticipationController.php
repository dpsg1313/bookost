...
class ParticipationController extends Controller
{
    ...
    private function validateForApply(Request $request): array{
        ...
        return $request->validate([
            ...
            'lactose' => 'required|boolean',
            'allergies' => 'nullable|string|max:255',
            'parent_name' => [$requiredIfUnder18, 'string', 'max:255'],
            'parent_phone' => [$requiredIfUnder18, 'string', 'max:255'],
            'parent_mobile' => [$requiredIfUnder18, 'string', 'max:255'],
            'parent_address' => [$requiredIfUnder18, 'string', 'max:255'],
