                        ...
                        <table class="table-auto">
                            ...
                            <tr v-for="participation in participations">
                                ...
                                <td class="border-r border-t px-1 text-center">
                                    <BreezeCheckbox :id="'paid'[participation.id]" class="m-1" v-model:checked="form[participation.id]" />
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
export default {
    ...
    data() {
        ...
        for(const participation of this.participations){
            formData[participation.id] = !!participation.paid_at;
        }
        return {
    ...
    methods: {
        save() {
            this.form.post(this.route('participation.savePayments'), {})
        },
    }
}
</script>
