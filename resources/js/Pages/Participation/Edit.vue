                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form action="#" @submit.prevent="">
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <p>Wir empfehlen die Impfung gegen Tetanus (Wundstarrkrampf) sowie FSME (Zecken) für alle Teilnehmenden des Zeltlagers. Bitte überprüft euren Impfschutz rechtzeitig und sprecht ggf. mit eurem Hausarzt.</p>
                            <div class="mt-2">
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                fishsticks: !!this.participation.fishsticks,
